...
Specialized skill for **optimization** operations in multi-agent environments (OpenClaw/KiloCode).

## Overview

Flux Capacitor helps execute optimization tasks with a secure, repeatable, and audit-friendly workflow.

## When to use

- You need structured execution in the **optimization** domain.
- You want reproducible outputs (plan, verification, rollback).
- You need explicit safety guardrails and operator control.

## Core capabilities

- Trigger-based activation for optimization scenarios.
...
**Input:** "Audit and improve optimization workflow."

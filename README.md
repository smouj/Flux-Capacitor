...
**Flux Capacitor** es una skill especializada en **optimization** para ecosistemas multiagente (OpenClaw/KiloCode), diseñada para ejecutar tareas con seguridad, trazabilidad y resultados reproducibles.

## Cuándo usarla

- Cuando la tarea pertenece al dominio de **optimization**.
...
**Input:** “Necesito revisar y endurecer el flujo de optimization”.
